...
void basic(string selectedCase)
{
    ...
    {
        select = false;
        if ((user->End_Time - user->Start_Time > map.get_value(user->Start_Point, user->End_Point)) && (user->Start_Time >= 0) && (user->End_Time <= 1440))
